...
def make_dataset(split_file, split, root, mode, num_classes, data):
    dataset = []
    i = 0
...
class NSLT(data_utl.Dataset):
    ...
    def __init__(self, split_file, split, root, mode, data, num_classes,transforms=None):
        self.num_classes = num_classes

        self.data = make_dataset(split_file, split, root, mode, self.num_classes, data)
