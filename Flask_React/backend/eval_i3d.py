...
def run(        init_lr=0.1,
    ...
    i3d.load_state_dict(torch.load(weights, map_location=lambda storage, loc: storage))  # nslt_2000_000700.pt nslt_1000_010800 nslt_300_005100.pt(best_results)  nslt_300_005500.pt(results_reported) nslt_2000_011400
    # i3d.cuda()
